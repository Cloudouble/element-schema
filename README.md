...
```
<script src="https://cdn.jsdelivr.net/gh/cloudouble/schema@1.0.3/schema.min.js"></script>
```
...
You can try this out with ```example.html```
```
<body>
  ...
  <script src="https://cdn.jsdelivr.net/gh/cloudouble/schema@1.0.3/schema.min.js"></script>
  <script src="https://cdn.jsdelivr.net/gh/cloudouble/schema@1.0.3/renders/microdata/microdata.min.js"></script>
  <script>
  window.LiveElement.Element.root = `https://cdn.jsdelivr.net/gh/cloudouble/schema@1.0.3/types`
...
* note the presence of the ```Schema.html``` file in there which is not autogenerated and should not be changed or deleted
